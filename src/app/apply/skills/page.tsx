    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="max-w-4xl mx-auto pt-32 px-6">
        <div className="bg-white p-10 border rounded-[3rem] shadow-xl">
          <h2 className="text-3xl font-black mb-8 flex items-center gap-3 uppercase text-[#0A192F]"><Briefcase className="text-blue-600"/> Skills Pathway</h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <input name="skill" placeholder="Your Primary Skill" className="w-full p-4 border rounded-2xl bg-slate-50" required />
            ...
            <textarea name="history" placeholder="Summary of your work history..." className="w-full p-4 border rounded-2xl h-32 bg-slate-50" required />
            <div className="border-2 border-dashed border-slate-200 rounded-2xl p-8 text-center relative hover:bg-slate-50">
              ...
              <p className="text-sm font-bold text-slate-500 uppercase">Upload Passport</p>
            </div>
