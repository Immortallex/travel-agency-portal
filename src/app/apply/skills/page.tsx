    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="max-w-3xl mx-auto pt-32 px-6">
        <div className="bg-white p-10 border rounded-[3rem] shadow-xl">
          <h2 className="text-3xl font-black mb-8 flex items-center gap-3 uppercase text-[#0A192F]"><Briefcase className="text-blue-600"/> Professional Skills</h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <input name="profession" placeholder="Your Profession (e.g. Nursing, Engineering)" className="p-4 border rounded-2xl bg-slate-50 mt-5" required />
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <select name="country" className="p-4 border rounded-2xl bg-slate-50" required>
                ...
                <option>UK</option><option>Canada</option><option>Australia</option><option>Germany</option><option>New Zealand</option>
              </select>
            </div>
            <input name="cv_link" placeholder="Link to Resume/CV (Drive/Dropbox)" className="w-full p-4 border rounded-2xl bg-slate-50" required />
            <textarea name="bio" placeholder="Provide a detailed professional summary of your expertise..." className="w-full p-4 border rounded-2xl h-32 bg-slate-50" required />
