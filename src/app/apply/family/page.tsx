...
export default function FamilyForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error("Server error during submission.");
      ...
      <div className="max-w-4xl mx-auto pt-32 px-6">
        <div className="bg-white p-10 border rounded-[3rem] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <input name="dependents" placeholder="Number of Dependents" type="number" className="w-full p-4 border rounded-2xl bg-slate-50" required />
