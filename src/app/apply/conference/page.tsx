...
import { Calendar, Upload, Loader2, CheckCircle2, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto pt-32 px-6">
        <div className="bg-white p-10 border rounded-[3rem] shadow-xl">
          <h2 className="text-3xl font-black flex items-center gap-3 uppercase text-[#0A192F] mb-8">
            <Calendar className="text-blue-600"/> Conference & Event Pathway
          </h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <input name="conferenceName" placeholder="Name of Conference/Event" className="p-4 border rounded-2xl bg-slate-50" required />
              <input name="eventDate" type="date" className="p-4 border rounded-2xl bg-slate-50" required />
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <input name="destinationCountry" placeholder="Host Country (e.g. USA, Canada)" className="p-4 border rounded-2xl bg-slate-50" required />
              <input name="currentOccupation" placeholder="Your Current Occupation" className="p-4 border rounded-2xl bg-slate-50" required />
            </div>
            <textarea name="relevance" placeholder="Why is this conference important to your career or organization?..." className="w-full p-4 border rounded-2xl h-32 bg-slate-50" required />
