...
import { Mic2, Upload, Loader2, ArrowRight, FileText } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto pt-32 px-6">
        <div className="bg-white p-10 border rounded-[3rem] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <input name="role" placeholder="Your Role (Speaker/Attendee)" className="p-4 border rounded-2xl bg-slate-50" required />
              <input name="location" placeholder="Conference Country" className="p-4 border rounded-2xl bg-slate-50" required />
            </div>
            <textarea name="abstract" placeholder="Describe the purpose of your attendance..." className="w-full p-4 border rounded-2xl h-32 bg-slate-50" required />
