    ...
    <div className="min-h-screen bg-white pb-20 pt-28">
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-[#0A192F] p-12 rounded-[3.5rem] shadow-2xl text-white">
          <h1 className="text-5xl font-black uppercase italic tracking-tighter mb-2">Sports <span className="text-blue-500">Recruitment</span></h1>
          <p className="text-slate-400 text-xs font-bold uppercase tracking-[0.3em] mb-12">Elite Scouting and Academy Placement.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="pt-10 border-t border-white/10 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <input name="club" placeholder="Current Club / Academy" required className="w-full p-5 bg-white/5 border border-white/10 rounded-2xl outline-none" />
              </div>
              <input name="video" placeholder="Highlight Video URL (YouTube/Google docs)" required className="w-full p-5 bg-white/5 border border-white/10 rounded-2xl outline-none" />
              <textarea name="awards" placeholder="List major awards, team achievements, or personal records..." required className="w-full p-5 bg-white/5 border border-white/10 rounded-2xl h-32 outline-none" />
            </div>
            ...
            <div className="p-8 bg-blue-500/10 border-2 border-dashed border-blue-500/30 rounded-[2.5rem] flex flex-col items-center text-center space-y-4">
              ...
              <h4 className="font-black uppercase tracking-widest text-sm">Upload Passport & Athlete Profile</h4>
