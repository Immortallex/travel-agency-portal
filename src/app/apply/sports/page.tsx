...
import { Trophy, Upload, Loader2, ArrowRight, FileText, Activity } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto pt-32 px-6">
        <div className="bg-white p-10 border rounded-[3rem] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <select name="sportType" className="p-4 border rounded-2xl bg-slate-50" required>
                <option value="">Sport Category</option><option>Football</option><option>Basketball</option><option>Athletics</option><option>Other</option>
              </select>
              <input name="position" placeholder="Playing Position / Event" className="p-4 border rounded-2xl bg-slate-50" required />
            </div>
            <div className="grid md:grid-cols-2 gap-6">
            ...
            <input name="club" placeholder="Current or Previous Professional Club" className="w-full p-4 border rounded-2xl bg-slate-50" required />
            ...
            <textarea name="achievements" placeholder="List your major career achievements and trophies..." className="w-full p-4 border rounded-2xl h-32 bg-slate-50" required />
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="border-2 border-dashed border-slate-200 rounded-2xl p-6 text-center relative hover:bg-slate-50">
                ...
                <p className="text-[10px] font-bold text-slate-500 uppercase">Sports Profile / CV</p>
              </div>
            </div>
