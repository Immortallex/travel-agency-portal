    ...
    <div className="max-w-3xl mx-auto p-10 bg-white border rounded-[3rem] my-12 shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid md:grid-cols-3 gap-4">
          <div className="flex flex-col"><label className="text-[10px] font-bold ml-2 text-slate-400">DOB</label><input name="dob" type="date" className="p-4 border rounded-2xl bg-slate-50" required /></div>
          <div className="flex flex-col"><label className="text-[10px] font-bold ml-2 text-slate-400">GENDER</label><select name="gender" className="p-4 border rounded-2xl bg-slate-50" required><option value="">Select</option><option>Male</option><option>Female</option></select></div>
          <div className="flex flex-col"><label className="text-[10px] font-bold ml-2 text-slate-400">SPORT</label><select name="sportType" className="p-4 border rounded-2xl bg-slate-50" required><option value="">Select</option><option>Football</option><option>Basketball</option><option>Athletics</option><option>Others</option></select></div>
        </div>
        <div className="grid md:grid-cols-2 gap-6">
          <input name="position" placeholder="Position (e.g. Striker, Point Guard)" className="p-4 border rounded-2xl bg-slate-50" required />
        ...
        <input name="videoHighlight" placeholder="Link to Video Highlights (YouTube/Vimeo)" className="w-full p-4 border rounded-2xl bg-slate-50" required />
